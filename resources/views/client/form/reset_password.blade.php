...
<div class="sm:mx-auto ">
    <h2 class="mt-6 text-center text-3xl font-bold md:text-white text-black ">Đặt lại mật khẩu</h2>
</div>
<div class="max-w-7xl mx-auto" >
    <div class="grid grid-cols-12 space-x-10  " >
        <div class=" col-span-3 flex justify-center items-center">
            <img style=" border-radius: 16px; height: 65vh" src="/img/Form/hinh1q.jpg" alt="Image 1" class="md:block hidden " />
        </div>
