...
class RoleController extends BaseController
{
    ...
    {
        return $dataTable->render('admin.roles.index2');
    }
    ...
    public function edit($id)
    {
        ...
        $rolePermissions = DB::table("role_has_permissions")
            ...
            ->pluck('permission_id')
            ->toArray();
        return view('admin.roles.edit2', compact('role', 'permission', 'rolePermissions'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->validate($request, [
            'name' => [
                'required',
                Rule::unique('admin.roles', 'name')->ignore($id)
            ],
            'permissions' => 'required'
        ]);
    ...
    {
        $unit = Roles::findOrFail($request->id);
        $unit->delete();
